...
class ventanaAlu:
    def abrirAlu():
        ...
        prof=Label(miFrame, text="Registro para Alumnos", fg="black")
        prof.pack()
        ...
        def botonAlumno():
           ...
           if nom!="" and apep!="" and apem!="" and gru!="" and bo!="":
               if len(name.get())<20 and len(apellidopa.get())<15 and len(apellidom.get())<15 and len(group.get())==4 and len(nboleta.get())==10 and nom.isalpha()==True and apep.isalpha()==True and apem.isalpha()==True:
                    ...
                    DatosA=DatosA(nombre.title(),apellidop.title(),apellidoma.title(),boleta,grupo.upper())
                    DatosA.guardar()
        ...
        butonalum=Button(miFrame, text="Registrar", command=botonAlumno)
        butonalum.pack()
